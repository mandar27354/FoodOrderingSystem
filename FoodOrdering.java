...
{  
	...
	ImageIcon im1;
  	...
  	{  
  	  	FoodOrdering t=new FoodOrdering();
...
{ 
	...
	public home()
 	{ 
		...
		l3=new JLabel("     *FEEL AND FLAVOUR*");
	...
	try  
 	{  
			...
			if(ae.getSource()==bt1)  
  	            ...
  	            Connection connection = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE", "system", "pccoe");
  	            ...
  	            String query = "INSERT INTO Customer_reg(nm, password, Contact, Address) VALUES (?, ?, ?, ?)";
 	...
 	{ 
       ...
       if(c3.isSelected()) 
		...
		if(c33.isSelected()) 
 	 	...
 	 	FoodOrdering.smsg=msg;
	 	FoodOrdering.samt=amt;
}
}
